...
interface HomeCollectionsPanelProps {
...
export default function HomeCollectionsPanel({
  onUploadRequest: _onUploadRequest,
  ...
  allItems.sort((a, b) => Number(b.data.createdAt) - Number(a.data.createdAt));
  ...
  const handleShare = useCallback(async () => {
    ...
    try {
      if (navigator.share) {
        await navigator.share({ title: "Shared from MYL", text: names });
      }
    } catch {}
    exitSelectionMode();
  ...
  return (
    <div
      ...
      data-ocid="home_collections.panel"
    >
      {/* Upload progress bar */}
      {uploads.length > 0 && (
        <div
          ...
          data-ocid="home_collections.upload.loading_state"
        >
        ...
        <div className="px-4 py-2 shrink-0 flex items-center justify-between">
          ...
          {selectionMode && (
            <button
              ...
              data-ocid="home_collections.cancel_button"
            >
              Cancel
            </button>
          )}
        ...
        {isLoading ? (
          <div className="flex items-center justify-center h-40">
            <div
              ...
              style={{ borderColor: amberColor, borderTopColor: "transparent" }}
              data-ocid="home_collections.loading_state"
            />
          </div>
        ) : allItems.length === 0 ? (
          <div
            className="flex flex-col items-center justify-center gap-3 px-8 py-16"
            data-ocid="home_collections.empty_state"
          >
            <svg
              width="56"
              height="56"
            ...
            {allItems.map((item, idx) => {
              ...
              return (
                <NoteThumbnail
                  ...
                  onTap={() => handleItemTap(item)}
                  onLongPress={() => handleItemLongPress(item)}
                  data-ocid={`home_collections.item.${idx + 1}`}
                />
              );
            })}
          </div>
      ...
      {/* Batch action toolbar — fixed above bottom nav */}
      {selectionMode && (
        <div
          style={{
            position: "fixed",
          ...
          data-ocid="home_collections.batch.panel"
        >
          <div className="flex items-center justify-between">
            <button
              ...
              data-ocid="home_collections.select_all_button"
            >
              <CheckSquare size={16} />
          ...
          <div className="flex items-center justify-around">
            <button
              ...
              data-ocid="home_collections.batch.mission.button"
            >
              <Target size={22} />
              <span>Mission</span>
            </button>
            <button
              ...
              data-ocid="home_collections.batch.folder.button"
            >
              <FolderInput size={22} />
              <span>Folder</span>
            </button>
            <button
              ...
              data-ocid="home_collections.batch.share.button"
            >
              <Share2 size={22} />
              <span>Share</span>
            </button>
            <button
              ...
              data-ocid="home_collections.batch.delete_button"
            >
              <Trash2 size={22} />
              <span>Delete</span>
            </button>
      ...
      {showDeleteConfirm && (
        <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/50">
          <div
            ...
            data-ocid="home_collections.delete.dialog"
          >
            <h2
            ...
            <div className="flex gap-3">
              <button
                ...
                data-ocid="home_collections.delete.cancel_button"
              >
                Cancel
              </button>
              <button
                ...
                data-ocid="home_collections.delete.confirm_button"
              >
                {deleteFilesMutation.isPending || deleteNotesMutation.isPending
                  ? "Deleting…"
                  : "Delete"}
        ...
        >
          ...
          >
            <button
              ...
              aria-label="Close"
              data-ocid="home_collections.note_viewer.close_button"
            >
              <svg
                width="22"
                height="22"
        ...
        >
          ...
          >
            <button
              ...
              style={{ color: textColor }}
              aria-label="Close"
              data-ocid="home_collections.link_viewer.close_button"
            >
              <svg
                width="22"
                height="22"
          ...
          <div className="flex-1 flex flex-col items-center justify-center gap-6 px-6">
            ...
            <button
              ...
              data-ocid="home_collections.link_viewer.open_button"
            >
              <LinkIcon size={18} />
              Open Link
            </button>
