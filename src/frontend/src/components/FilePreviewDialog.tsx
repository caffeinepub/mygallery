...
const FilePreview = memo(
  ({
    ...
    fileCategory,
    fileUrl,
  }: { file: FileMetadata; fileCategory: string; fileUrl: string }) => {
    if (fileCategory === "image") {
      return <img src={fileUrl} alt={file.name} className="h-auto w-full" />;
    }
...
export default function FilePreviewDialog({
  ...
  const showPreviewActions =
    ["image", "video", "pdf", "office"].includes(fileCategory) && file.blob;
      ...
      <AlertDialog open={showDeleteConfirm} onOpenChange={setShowDeleteConfirm}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete the file "{file.name}"? This
