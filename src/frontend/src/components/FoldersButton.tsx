    ...
    return (
      ...
      >
        <div className="relative">
          <div
            className={`w-[5.5rem] h-[5.5rem] flex items-center justify-center rounded-xl bg-sky-100 dark:bg-sky-900/30 transition-all duration-200 ${
              !disabled &&
              "group-hover:bg-sky-200 dark:group-hover:bg-sky-900/50"
            }`}
          >
            <Folder
