...
export default function MissionsButton({ onClick, disabled = false }: MissionsButtonProps) {
  return (
    <button
      onClick={onClick}
      disabled={disabled}
      className={`fixed bottom-16 left-[17rem] z-40 flex flex-col items-center gap-1.5 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-missions-accent focus:ring-offset-2 rounded-lg p-2 group ${
        disabled 
